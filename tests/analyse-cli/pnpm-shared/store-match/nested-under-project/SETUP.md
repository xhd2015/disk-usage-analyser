...
**Leaf**: nested `project/node_modules` bubbles `pnpm_shared` onto `project` row

## Steps

1. Create fixture store `files/aa/<hash>` (4096 B).
2. Clone store file into `project/node_modules/pkg/file` via `cp -c`.
...
func Setup(t *testing.T, req *Request) error {
	...
	cloneStoreFileTo(t, storeFile, "project/node_modules/pkg/file", req.FixtureDir)
